...
set(LLVM_ENABLE_PROJECTS "llvm;clang;lld;clang-tools-extra;polly" CACHE STRING "")
...
# Has not been complete implemented
...
# set(OPENMP_ENABLE_LIBOMPTARGET ON CACHE STRING "")
...
#   Specified distribution component 'lldb' doesn't have an install target
# Call Stack (most recent call first):
#   CMakeLists.txt:1331 (llvm_distribution_add_targets)
# 
# 
# CMake Error at cmake/modules/LLVMDistributionSupport.cmake:284 (message):
#   Specified distribution component 'lldb' doesn't have an install-stripped
...
#   'install-lldb-stripped' target.
# Call Stack (most recent call first):
#   CMakeLists.txt:1331 (llvm_distribution_add_targets)
  # lldb

set(LLVM_RUNTIME_TARGETS
compiler-rt;libcxx;libcxxabi;libunwind;pstl;openmp)
